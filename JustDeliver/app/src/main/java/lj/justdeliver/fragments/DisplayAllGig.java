...
import lj.justdeliver.adapters.DriverAllGigsRecyclerAdapter;
import lj.justdeliver.model.OneGig;

import static android.content.Context.MODE_PRIVATE;

public class DisplayAllGig extends Fragment {
    private ArrayList<OneGig> gigList;
    private DatabaseReference dbRef;
    private ValueEventListener eventListner;
    private DriverAllGigsRecyclerAdapter gigAdapter;
    private Query query;


    public DisplayAllGig() {
        // Required empty public constructor
    }

    public static DisplayAllGig newInstance() {
        DisplayAllGig fragment = new DisplayAllGig();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        query = dbRef.orderByChild("driverID").equalTo("no");
        ...
        gigAdapter = new DriverAllGigsRecyclerAdapter(getActivity(), gigList);
